...
const CaseStudies = {
              ...
              <hr class='ultralight-border text-center w-25 higher' />
               ...
               <div class="row justify-content-center d-flex low-gutter pt-2">
                <div id='cases_1' data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-duration="1000" class="d-flex col-md-3 col-6 offset-1 pb-2 isomorph-o blur-bg rounded-border jdorsey">
                          <p class='col-md-8 col-md-auto offset-md-2 col-12 w-100 p-2 text-center blur-bg-s'> <i class="fas fa-vials xlg-text pt-2"></i><br/><span class="font-weight-bold">As simple as ABC</span> <br/>Focused selection of products through rigorous research to inspire a simpler living. </p>
  </div>
                ...
                <p class='col-md-8 col-md-auto offset-md-2 col-12 w-100 p-2 text-center blur-bg-s'><i class="fas fa-vector-square xlg-text p-1"></i> <br/><span class="font-weight-bold">Design x Functionality</span> <br/>Curated for those who subscribe to minimal design while maintaining the best functionality in their homes. </p>
 </div>
 <div id='cases_3' data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-duration="1000" class="d-flex  col-md-3 col-6 offset-1 pb-2 isomorph-o ">
                <p class='col-md-8 col-md-auto offset-md-2 col-12 w-100 p-2 text-center blur-bg-s'> <i class="fas fa-people-arrows xlg-text pt-2"></i><br/><span class="font-weight-bold">One on One</span><br/> Personal experience for each customer. Any concern with the products you've purchased, please don't hesitate to <a href="/#/contact"> mail</a> us . </p></div>
</div>
</div>
</section>
