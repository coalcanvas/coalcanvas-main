const About = {
  ...
  render: async () => {
    return /*html*/ `
      ...
      <section id='about' class='glow col-md-10 col-12 offset-md-1 col-auto col-md-auto'>
      ...
      <div class="container-fluid  pb-5 mb-5">
              ...
              <hr class='ultralight-border text-center w-25 higher' />
                ...
                <div id='about_1' data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-duration="1000" class="d-flex  col-md-3 col-6 offset-1 pb-2 isomorph-o blur-bg rounded-border jdorsey">
                                <p class='col-md-8 col-md-auto offset-md-2 col-12 w-100 p-2 text-center blur-bg-s'> <i class="fas fa-concierge-bell xlg-text pt-2"></i></i><br/><span class="font-weight-bold big-ho">Attention Grabbing</span> <br/> <br/>Rigorous research & testing of simple & attractive UI interactions that inspire action. </p>
  </div>
                 <div id='about_2' data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-duration="1000" class="d-flex sub col-md-3 col-6 offset-1 pb-2 isomorph-o  rounded-border techno">
 ...
 <div id='about_3' data-aos="zoom-in" data-aos-offset="50" "data-aos-easing="ease-in-sine" data-aos-duration="1000" class="d-flex  col-md-3 col-6 offset-1 pb-2 isomorph-o  rounded-border taxi">
