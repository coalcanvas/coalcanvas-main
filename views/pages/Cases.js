    ...
    return /*html*/ `
      ...
      <div class="container-fluid  pb-5 mb-5">
              ...
              <hr class='ultralight-border text-center w-25 higher' />
                ...
                Use cases curated to inspire and trigger action. <br /> <em class='text-muted xsmall-text'>this will be an archive of all the use cases arising from research, experimentation and other real-life projects to enable others on their own journey.</em></p></div>
