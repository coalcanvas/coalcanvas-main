...
const cardOptions = [
	{
		imageURL: {
			default: require("../img/desert-dark.jpg"),
			hovered: require("../img/desert-bright.jpg"),
	...
	{
		imageURL: {
			default: require("../img/forest.jpg"),
			hovered: require("../img/forest-top.jpg"),
	...
	{
		imageURL: {
			default: require("../img/ocean-top.jpg"),
			hovered: require("../img/ocean.jpg"),
...
// after all img are loaded remove loader
// (this is not the best way to do so but it gets the job done)
loadImages(imageURLS, (img) => {
	// this array holds the img in a sub array
	// i.e [img, img, img, img, img, img] ==> [[img, img], [img, img], [img, img]]
	const splitedImagesArray = splitArray(img, 2);
